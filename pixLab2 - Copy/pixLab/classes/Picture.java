...
public class Picture extends SimplePicture 
{
  ...
  public void grayscale(){
      ...
      for (int row = 0; row < pixels.length; row++){
          for (int col = 0; col < pixels[0].length; col++){
              pixel = pixels[row][col];
              int a = (pixel.getRed() + pixel.getBlue() + pixel.getGreen())/3;
              pixel.setRed(a);
              pixel.setBlue(a);
              pixel.setGreen(a);
            }
  ...
  public void copyTwo(Picture fromPic, int startRow, int startCol, int endRow,
  int endCol){
  ...
  public void myCollage(){
      ...
      Picture lads = new Picture("lads.jpg");
      Picture beach = new Picture("beach.jpg");
      this.copy(gull, 0, 0);
      this.copy(beach, 100, 0);
      this.copy(lads, 200, 0);
     Picture ladsNoBlue = new Picture(lads);
     ladsNoBlue.zeroBlue();
     this.copy(ladsNoBlue, 300, 0);
     this.copy(gull, 400, 0);
  ...
  public void groupEdgeDetection(int edgeDist){
    Pixel[][] pixels = this.getPixels2D();
    Pixel topPixel = null;
    Pixel botPixel = null;
    Color botColor = null;
    Picture other = new Picture(this);
    Pixel leftPixel = null;
    Pixel rightPixel = null;
